...
Doodle jump is an iconic game, one of the first games to implement usage of the smartphone's gyroscope to control the charcter's movement.
As much as doodle jump was a leader in the mobile gaming industry, it is outdated in every aspect.
The graphics are lacking, movement is stiff and unnatural, and the gameplay is stale.
Shoot for the Sky will implement more natural and fast paced movement, with dated graphics and animation and the most unique part is the powerups and equipment system.

Icy tower

![icy_tower](https://user-images.githubusercontent.com/74679553/226709524-931491c6-0596-4473-967b-5b643127cf95.gif)

Icy tower is another nostalgic game which we all know and love.
Icy tower's most unique feature is a very dynamic and natural movement, which rewards players for having quick fingers.
What the game lacks is a more engaging gameplay, as all the player can do is move left right and jump, which leaves the player with only one conflict, which platform should he go to next.
Shoot for the Sky will have alot more features to engage the player- enemies to defeat, special powerups to collect and different equipment to try.
...
Mega jump is a great game, bright colors and simple gameplay.
Mega jump offers a fast paced and flashy gameplay, different powerups to collect and a unique core proccess- collect coins to ascend instead of jumping on platforms.
Mega jump's fast paced gameplay is its strognest feature, but as the game progress the gameplay doesn't really change other than moving quicker.
Shoot for the Sky will feature stronger enemies the longer the player climbs, also different powerups and equipments to try and collect, which gives the player incentives to climb higher other than having a higher score.



Shoot for the Sky's most interesting formal elements are the resource and the law elements.
* Resource element- we have diverse and satisfying powerups, that will drastically change the player movement feel in the game, making him feel stronger or quicker.
The equipment system will give the player new tools to deal with enemies, which completely change how the player engages with them. Different equipment are to be found in different stages of the game, reach higher levels and find better equipment!
